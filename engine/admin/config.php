...
?>";
  if (file_put_contents(ENGINE_DIR . '/data/config.php', $write)) {
...
<table>
 <tbody>
    <tr>
      ...
      <td>
        <input class="input" required type="text" name="title" value="<?= $config['title'];?>">
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <input class="input" type="text" name="description" value="<?= $config['description'];?>">
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <textarea style="height:60px;max-width:280px;" class="input" name="keywords"><?= $config['keywords'];?></textarea>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <input class="input" type="email" name="email" value="<?= $config['admin_mail'];?>">
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <input class="input" required type="password" name="reg_key" value="<?= $config['reg_key'];?>">
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <input style="padding-right:0;width:290px;" class="input" required type="number" min="0" name="news_num" value="<?= $config['shownews'];?>">
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <input style="padding-right:0;width:290px;" class="input" required type="number" min="0" name="prog_num" value="<?= $config['showprog'];?>">
      </td>
    </tr>
    <tr>
      <td>
